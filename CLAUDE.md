...
This protocol is mandatory at the end of every session.
No exceptions. Claude Code is responsible for executing
every step.

Step 1: Draft CHANGELOG entry.
Step 2: Draft CLAUDE.md changes if any.
...
- PATCH increments for small fixes within a session
- MINOR increments for a completed prototype or
...
render inline in the same panel. Images stored in
Supabase, displayed alongside the citation and analysis.

REASONABLY EXHAUSTIVE SEARCH CHECKLIST -- GPS requires
the researcher to affirmatively account for what was
searched and what was not. This belongs as a dedicated
stage in the Case Study Builder between the Evidence
Chain and Conflict Analysis stages.

## Claude Code Instructions

Always work in /Users/dave/Project-G/
Prepend cd /Users/dave/Project-G && to every bash
command. Never write files to any other directory.
